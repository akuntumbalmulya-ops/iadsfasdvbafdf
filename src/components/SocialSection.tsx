...
const SOCIAL_LINKS: SocialLink[] = [
  ...
  },
  {
    name: "Instagram",
    icon: (
      <svg viewBox="0 0 24 24" className="w-full h-full" style={{ fill: 'url(#instagram-gradient-unique)' }}>
        <defs>
          <linearGradient id="instagram-gradient-unique" x1="0%" y1="100%" x2="100%" y2="0%">
