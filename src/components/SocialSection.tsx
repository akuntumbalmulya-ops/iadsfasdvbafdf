...
const SOCIAL_LINKS: SocialLink[] = [
  {
    name: "Discord",
    displayName: "Group Discord Glois",
    icon: (
      <svg viewBox="0 0 24 24" className="w-8 h-8 sm:w-10 sm:h-10" style={{ fill: '#5865F2' }}>
  ...
  },
  {
    ...
    icon: (
      <svg viewBox="0 0 24 24" className="w-8 h-8 sm:w-10 sm:h-10" style={{ fill: '#0A66C2' }}>
  ...
  },
  {
    ...
    icon: (
      <svg viewBox="0 0 24 24" className="w-8 h-8 sm:w-10 sm:h-10" style={{ fill: '#FF0000' }}>
  ...
  {
    name: "X",
    displayName: "My Account X",
    icon: (
      <svg viewBox="0 0 24 24" className="w-8 h-8 sm:w-10 sm:h-10" style={{ fill: '#FFFFFF' }}>
